...
<html lang="en">
  ...
  <form action="/Lista2/exer20resp.php" method="POST">
    <div class="border p-3 m-3">
        <div class="row">
            <div class="col">
                <label for="valor1" class="form-label">Informe uma distância: </label>
                <input type="number" name="valor1" id="valor1" class="form-control">
            </div>
            <div class="col">
                <label for="valor2" class="form-label">Informe um tempo (h): </label>

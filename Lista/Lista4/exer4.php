...
<html lang="en">
  ...
  <body>
    ...
    <form action="/exer4res.php" method="POST">
        <div class="border p-3 m-3">
            <div class="row border">
                <div class="col">
                    <label for="dia" class="form-label">Informe o Dia</label>
                    <input type="number" min='1' name="dia" id="dia" class="form-control">
                </div> 
                <div class="col">
                    <label for="mes" class="form-label">Informe o Mês</label>
                    <input type="number" min='1' name="mes" id="mes" class="form-control">
                </div> 
                <div class="col">
                    <label for="ano" class="form-label">Informe o Ano</label>
                    <input type="number" min="1" name="ano" id="ano" class="form-control">
                </div> 
            </div>
